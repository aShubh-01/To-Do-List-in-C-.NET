...
namespace SMS
{
    public partial class Form8 : Form
    {
        ...
        {
            con.Open();
            SqlDataAdapter sqlda = new SqlDataAdapter("SELECT * FROM WorkTask", con);
        ...
        {
            con.Open();
            String query = "INSERT INTO WorkTask VALUES('" + textBox1.Text + "','" + dateTimePicker1.Value.ToString("yyyy-MM-dd") + "','" + dateTimePicker2.Value.ToString("yyyy-MM-dd") + "');";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                String query = "UPDATE WorkTask SET TaskDescription = '" + textBox1.Text + "',StartDate = '" + dateTimePicker1.Value.ToString("yyyy-MM-dd") + "', EndDate = '" + dateTimePicker2.Value.ToString("yyyy-MM-dd") + "' WHERE TaskDescription = '" + textBox2.Text + "';";
                SqlCommand cmd = new SqlCommand(query, con);
                cmd.ExecuteNonQuery();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                String query = "DELETE FROM WorkTask WHERE TaskDescription = '" + textBox2.Text + "';";
                SqlCommand cmd = new SqlCommand(query, con);
                cmd.ExecuteNonQuery();
